...
CREATE TABLE IF NOT EXISTS `omega-art-450811-b0.silver_dataset.customers`
(
   customer_id INT64,                     
    name STRING,                         
    email STRING,                      
...
MERGE INTO  `omega-art-450811-b0.silver_dataset.customers` target
USING 
  (SELECT DISTINCT
    *, 
    CASE 
    ...
    True as is_active
  FROM `omega-art-450811-b0.bronze_dataset.customers`) source
...
CREATE TABLE IF NOT EXISTS `omega-art-450811-b0.silver_dataset.orders`
(
    order_id INT64,
    customer_id INT64,
    order_date STRING,
...
MERGE INTO `omega-art-450811-b0.silver_dataset.orders` target
USING 
  (SELECT DISTINCT
    *, 
    CURRENT_TIMESTAMP() AS effective_start_date,
    CURRENT_TIMESTAMP() AS effective_end_date,
    TRUE AS is_active
  FROM `omega-art-450811-b0.bronze_dataset.orders`) source
...
CREATE TABLE IF NOT EXISTS `omega-art-450811-b0.silver_dataset.order_items`
(
    order_item_id INT64,
    order_id INT64,
    product_id INT64,
...
-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
--Step 2: Update Existing Active Records if There Are Changes
MERGE INTO `omega-art-450811-b0.silver_dataset.order_items` target
USING 
  (SELECT DISTINCT
    *, 
    CURRENT_TIMESTAMP() AS effective_start_date,
    CURRENT_TIMESTAMP() AS effective_end_date,
    TRUE AS is_active
  FROM `omega-art-450811-b0.bronze_dataset.order_items`) source
...
CREATE TABLE IF NOT EXISTS `omega-art-450811-b0.silver_dataset.categories`
(
    category_id INT64,
    name STRING,
    updated_at STRING,
...
TRUNCATE TABLE `omega-art-450811-b0.silver_dataset.categories`;

--Step 3: Insert New or Updated Records
INSERT INTO `omega-art-450811-b0.silver_dataset.categories`
SELECT 
  *,
  CASE 
...
FROM `omega-art-450811-b0.bronze_dataset.categories`;
...
CREATE TABLE IF NOT EXISTS `omega-art-450811-b0.silver_dataset.products`
(
  product_id INT64,
  name STRING,
  category_id INT64,
...
--Step 2: Truncate table
TRUNCATE TABLE `omega-art-450811-b0.silver_dataset.products`;

--Step 3: Insert New or Updated Records
INSERT INTO `omega-art-450811-b0.silver_dataset.products`
SELECT 
  *,
  CASE 
    WHEN category_id IS NULL OR name IS NULL THEN TRUE
...
FROM `omega-art-450811-b0.bronze_dataset.products`;
...
CREATE TABLE IF NOT EXISTS `omega-art-450811-b0.silver_dataset.product_suppliers`
(
    supplier_id INT64,
    product_id INT64,
...
-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
--Step 2: Update Existing Active Records if There Are Changes
MERGE INTO `omega-art-450811-b0.silver_dataset.product_suppliers` target
USING 
  (SELECT 
    *, 
    CURRENT_TIMESTAMP() AS effective_start_date,
    CURRENT_TIMESTAMP() AS effective_end_date,
    TRUE AS is_active
  FROM `omega-art-450811-b0.bronze_dataset.product_suppliers`) source
...
CREATE TABLE IF NOT EXISTS `omega-art-450811-b0.silver_dataset.suppliers`
(
  supplier_id INT64,
...
--Step 2: Truncate table
TRUNCATE TABLE `omega-art-450811-b0.silver_dataset.suppliers`;

--Step 3: Insert New or Updated Records
INSERT INTO `omega-art-450811-b0.silver_dataset.suppliers`
SELECT 
  *,
  CASE 
...
FROM `omega-art-450811-b0.bronze_dataset.suppliers`;
...
CREATE TABLE IF NOT EXISTS `omega-art-450811-b0.silver_dataset.customer_reviews`
(
    id STRING,
    customer_id INT64,
    product_id INT64,
...
-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
--Step 2: Update Existing Active Records if There Are Changes
MERGE INTO `omega-art-450811-b0.silver_dataset.customer_reviews` target
USING 
  (SELECT 
    *, 
    CURRENT_TIMESTAMP() AS effective_start_date,
    CURRENT_TIMESTAMP() AS effective_end_date,
    TRUE AS is_active
  FROM `omega-art-450811-b0.bronze_dataset.customer_reviews`) source
